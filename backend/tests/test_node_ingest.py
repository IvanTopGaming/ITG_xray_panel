def test_diff_snapshots_no_baseline_returns_empty():
    from panel_core.jobs.panels import _diff_snapshots
...
def test_poll_linked_panels_ingests_node_traffic_across_two_cycles(app, db):
    ...
    from panel_core.models import NodeTrafficSnapshot
    ...
    with (
        ...
        patch("panel_core.jobs.panels.get_redis", return_value=fake_redis),
    ):
        poll_linked_panels()
